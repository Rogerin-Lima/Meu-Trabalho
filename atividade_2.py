...
nome, cont = busca_binaria(lista, 256)

print("Nome do alvo:", nome)
print("Tentativas usando pesquisa binaria:", cont)
print("Tentativas usando pesquisa sequencial:", cont_sequencial)